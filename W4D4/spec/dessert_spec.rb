...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      cookie.add_ingredient("chocolate chip")
      expect(cookie.ingredients).to include("chocolate chip")
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { cookie.eat(55) }.to raise_error("not enough left!")
    end
  end
  ...
  describe "#serve" do                             
    it "contains the titleized version of the chef's name" do
      ...
      expect(cookie.serve).to eq("Chef Ryan the Great Baker has made 50 cookies!")
    end
  end
